...
<b>Dotabuff profile</b>: <a href="https://dotabuff.com/players/{1}">dotabuff.com/players/{1}</a><br>
...
<b>Last year win rate</b>: {5}<br><br>
                '''.format(
                    ...
                    player['player_id'],
                    player['player_name'],
                    str(player['week_wr']) + ' %' if player['week_wr'] != -1.00 else 'Not played since last week',
                    str(player['month_wr']) + ' %' if player['month_wr'] != -1.00 else 'Not played since last month',
                    str(player['year_wr']) + ' %' if player['year_wr'] != -1.00 else 'Not played since last year')
